package com.example.java_cine_api.dto.movie;
...
public class CreateMovieFromTmdbDto {
    ...
    // Constructeurs
    public CreateMovieFromTmdbDto() {}

    public CreateMovieFromTmdbDto(Integer tmdbId, Float rating, Boolean wishlist, String review, Integer viewCount, Boolean watched, String titleOverride) {
        this.tmdbId = tmdbId;
        this.rating = rating;
